...
public class TVBDDB_Play extends AppCompatActivity implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, View.OnTouchListener,HandlerUtils.OnReceiveMessageListener{
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        videoView = findViewById(R.id.db_videoView);
    ...
    public void initVideoView(){
        ...
        videoView.setVideoURI(Uri.parse("http://172.16.0.8/video/001.mp4"));
        //设置为全屏模式播放
