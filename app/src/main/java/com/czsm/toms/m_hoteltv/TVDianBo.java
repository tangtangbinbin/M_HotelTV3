...
public class TVDianBo extends Activity implements MediaPlayer.OnCompletionListener, MediaPlayer.OnErrorListener, MediaPlayer.OnPreparedListener, View.OnTouchListener {
    ...
    int index = 0;
    String[] tvip = new String[]{"http://192.168.2.57/live/iptv001.m3u8",
            "http://192.168.2.57/live/iptv002.m3u8",
            "http://192.168.2.57/live/iptv003.m3u8",
            "http://192.168.2.57/live/iptv004.m3u8",
            "http://192.168.2.57/live/iptv005.m3u8",
            "http://192.168.2.57/live/iptv006.m3u8",
            "http://192.168.2.57/live/iptv007.m3u8",
            "http://192.168.2.57/live/iptv008.m3u8"};
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_tvdian_bo);
